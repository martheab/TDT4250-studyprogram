...
/**
 * This is the item provider adapter for a {@link studyprograms.Programme} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProgrammeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 StudyprogramsPackage.Literals.PROGRAMME__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 StudyprogramsPackage.Literals.PROGRAMME__CODE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addStartYearPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Programme_startYear_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Programme_startYear_feature", "_UI_Programme_type"),
				 StudyprogramsPackage.Literals.PROGRAMME__START_YEAR,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 StudyprogramsPackage.Literals.PROGRAMME__DURATION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	protected void addSemestersPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Programme_semesters_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Programme_semesters_feature", "_UI_Programme_type"),
				 StudyprogramsPackage.Literals.PROGRAMME__SEMESTERS,
				 true,
				 false,
				 false,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(StudyprogramsPackage.Literals.PROGRAMME__SPECIALISATIONS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(StudyprogramsPackage.Literals.PROGRAMME__SPECIALISATIONS,
				 StudyprogramsFactory.eINSTANCE.createSpecialisation()));
	}
