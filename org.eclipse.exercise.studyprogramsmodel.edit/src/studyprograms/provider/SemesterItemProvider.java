...
public class SemesterItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addSemesterCodePropertyDescriptor(object);
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 StudyprogramsPackage.Literals.SEMESTER__YEAR,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 StudyprogramsPackage.Literals.SEMESTER__SEMESTER_TYPE,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Semester Code feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addSemesterCodePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Semester_semesterCode_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Semester_semesterCode_feature", "_UI_Semester_type"),
				 StudyprogramsPackage.Literals.SEMESTER__SEMESTER_CODE,
				 false,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(StudyprogramsPackage.Literals.SEMESTER__COURSE_ACCESS);
		}
	...
	public String getText(Object object) {
		String label = ((Semester)object).getSemesterCode();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(StudyprogramsPackage.Literals.SEMESTER__COURSE_ACCESS,
				 StudyprogramsFactory.eINSTANCE.createCourseAccess()));
	}
