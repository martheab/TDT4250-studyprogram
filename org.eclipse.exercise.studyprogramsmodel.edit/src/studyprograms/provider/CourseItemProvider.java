...
public class CourseItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addEctsPropertyDescriptor(object);
			addLevelPropertyDescriptor(object);
			addAvailableSemesterPropertyDescriptor(object);
		}
	...
	/**
	 * This adds a property descriptor for the Ects feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addEctsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Course_ects_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Course_ects_feature", "_UI_Course_type"),
				 StudyprogramsPackage.Literals.COURSE__ECTS,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Available Semester feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addAvailableSemesterPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Course_availableSemester_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Course_availableSemester_feature", "_UI_Course_type"),
				 StudyprogramsPackage.Literals.COURSE__AVAILABLE_SEMESTER,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
