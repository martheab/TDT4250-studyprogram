...
public class StudyprogramsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case StudyprogramsPackage.INDIVIDUAL_STUDY_PLAN: {
			...
			case StudyprogramsPackage.COURSE_ACCESS: {
				CourseAccess courseAccess = (CourseAccess)theEObject;
				T result = caseCourseAccess(courseAccess);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Course Access</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Course Access</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseCourseAccess(CourseAccess object) {
		return null;
	}
