...
public class StudyprogramsAdapterFactory extends AdapterFactoryImpl {
	...
	protected StudyprogramsSwitch<Adapter> modelSwitch =
		new StudyprogramsSwitch<Adapter>() {
			...
			@Override
			public Adapter caseCourseAccess(CourseAccess object) {
				return createCourseAccessAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link studyprograms.IndividualStudyPlan <em>Individual Study Plan</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link studyprograms.CourseAccess <em>Course Access</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link studyprograms.Department <em>Department</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
