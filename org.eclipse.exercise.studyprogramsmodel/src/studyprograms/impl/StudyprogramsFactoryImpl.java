...
public class StudyprogramsFactoryImpl extends EFactoryImpl implements StudyprogramsFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case StudyprogramsPackage.INDIVIDUAL_STUDY_PLAN: return createIndividualStudyPlan();
			case StudyprogramsPackage.SEMESTER: return createSemester();
			case StudyprogramsPackage.COURSE_ACCESS: return createCourseAccess();
			case StudyprogramsPackage.DEPARTMENT: return createDepartment();
			default:
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			...
			case StudyprogramsPackage.AVAILABLE_SEMESTERS:
				return createAvailableSemestersFromString(eDataType, initialValue);
	...
	public String convertToString(EDataType eDataType, Object instanceValue) {
		switch (eDataType.getClassifierID()) {
			...
			case StudyprogramsPackage.AVAILABLE_SEMESTERS:
				return convertAvailableSemestersToString(eDataType, instanceValue);
			case StudyprogramsPackage.SEMESTER_TYPE:
	 ...
	 */
	@Override
	public CourseAccess createCourseAccess() {
		CourseAccessImpl courseAccess = new CourseAccessImpl();
		return courseAccess;
	}
	 ...
	 * @generated
	 */
	public AvailableSemesters createAvailableSemestersFromString(EDataType eDataType, String initialValue) {
		AvailableSemesters result = AvailableSemesters.get(initialValue);
		if (result == null) throw new IllegalArgumentException("The value '" + initialValue + "' is not a valid enumerator of '" + eDataType.getName() + "'");
		return result;
	}
	 ...
	 * @generated
	 */
	public String convertAvailableSemestersToString(EDataType eDataType, Object instanceValue) {
		return instanceValue == null ? null : instanceValue.toString();
	}
